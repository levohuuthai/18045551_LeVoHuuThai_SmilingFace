...
public class MainActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRegis3 = findViewById(R.id.btnRegis3);

        auth = FirebaseAuth.getInstance();

        btnRegis3.setOnClickListener(new View.OnClickListener() {
            @Override
                ...
                auth.createUserWithEmailAndPassword(email, password)
                        .addOnCompleteListener(MainActivity3.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                Toast.makeText(MainActivity3.this, "createUserWithEmail:onComplete:" + task.isSuccessful(), Toast.LENGTH_SHORT).show();
